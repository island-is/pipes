      ...
      return /*#__PURE__*/ React.createElement(
        ...
        Object.keys(input).map((key, index) => {
          return /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(Text, null, "\n", "  ".repeat(padding + 1), maskString(key), ":", " "),
            sanitize(input[key], padding + 1, seen),
          );
        }),
      );
    }
...
function ErrorOverview({ error }) {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(Text, null, " ", error.message),
    ),
    origin &&
      filePath &&
      /*#__PURE__*/ React.createElement(
...
class App extends PureComponent {
  ...
  render() {
    return /*#__PURE__*/ React.createElement(
      ...
      null,
      this.state.error
        ? /*#__PURE__*/ React.createElement(ErrorOverview, {
...
const Dialog = (props) => {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    typeof props.dialogType === "string" && props.dialogType !== "default"
      ...
      : /*#__PURE__*/ React.createElement(Container, null, /*#__PURE__*/ React.createElement(React.Fragment, null)),
  ...
  ansi: (component) => {
    ...
    if (ciinfo.GITHUB_ACTIONS) {
      ...
      return /*#__PURE__*/ React.createElement(
        React.Fragment,
        null,
        /*#__PURE__*/ React.createElement(Text, null, startGroup),
        component.children,
        /*#__PURE__*/ React.createElement(Text, null, endGroup),
      );
    }
    return /*#__PURE__*/ React.createElement(
      React.Fragment,
...
const invalidTime = /*#__PURE__*/ React.createElement(
  SpaceText,
  {
    color: "red",
  },
...
const invalidDateFormat = /*#__PURE__*/ React.createElement(
  SpaceText,
  {
    color: "red",
  },
 ...
 */ function row(config) {
  ...
  /* Row */ return (props) =>
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(skeleton.component, null, skeleton.left),
      ...intersperse(
        (i) => {
...
class DOMError extends Error {
  ...
  constructor(pipeComponent) {
    ...
    this.#message = /*#__PURE__*/ React.createElement(
      React.Fragment,
      null,
      pipeComponent,
      /*#__PURE__*/ React.createElement(Error$1, null, this.stack),
    );
  }
  get = () => {
    return this.#message;
...
const throwJSXError = (context, config, errorMSG, shouldRender = true) => {
  ...
  const jsx = /*#__PURE__*/ React.createElement(
    Container,
    null,
    /*#__PURE__*/ React.createElement(Error$1, null, "Error in context: ", appName),
    jsxSTACK,
    /*#__PURE__*/ React.createElement(Error$1, null, unknownToString(errorMSG)),
  );
  if (shouldRender) {
    void render(() => jsx, {
      forceRenderNow: true,
      ...
      ((state, duration) => {
        ...
        if (state === "Completed") {
          return /*#__PURE__*/ React.createElement(
            Success,
            null,
            /*#__PURE__*/ React.createElement(Text, null, texts.finished),
            /*#__PURE__*/ React.createElement(Timestamp, {
              time: duration,
              format: "mm:ss.SSS",
            }),
  ...
  async run() {
    ...
    await connect(
      async (client) => {
        ...
        /** Add all context */ this.#contextPromiseAggregator.addPromise(
