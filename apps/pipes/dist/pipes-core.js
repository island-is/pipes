    ...
    return createReconciler({
        ...
        createTextInstance (text, _root, hostContext) {
            if (!hostContext.isInsideText) {
                ...
                throw new Error(`Text string "${text}" must be rendered inside <Text> component but got ${JSON.stringify(_root)}`);
            }
...
const renderRow = {
    ansi: (component)=>{
        ...
        const widths = Array(children.length).fill(0).map((_e, index)=>{
...
// eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
const throwJSXError = (context, config, errorMSG)=>{
    const { stack } = context;
    const { appName } = config;
    const jsxSTACK = stack.map((e, index)=>/*#__PURE__*/ React.createElement(Error$1, {
            key: index
        }, /*#__PURE__*/ React.createElement(Text, null, e)));
    const contextError = context ? /*#__PURE__*/ React.createElement(Info, null, /*#__PURE__*/ React.createElement(Text, {
        bold: true
    }, "Context"), /*#__PURE__*/ React.createElement(PipesObject, {
        value: context
    })) : /*#__PURE__*/ React.createElement(React.Fragment, null);
    const configError = config ? /*#__PURE__*/ React.createElement(Info, null, /*#__PURE__*/ React.createElement(Text, {
        bold: true
    }, "Config"), /*#__PURE__*/ React.createElement(PipesObject, {
        value: config
    })) : /*#__PURE__*/ React.createElement(React.Fragment, null);
    const jsx = /*#__PURE__*/ React.createElement(Container, null, /*#__PURE__*/ React.createElement(Error$1, null, "Error in context: ", appName), contextError, configError, jsxSTACK, /*#__PURE__*/ React.createElement(Error$1, null, /*#__PURE__*/ React.createElement(PipesObject, {
        value: errorMSG
    })));
