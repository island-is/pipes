...
const should_use_source_extension_for_local_packages = process.env["PIPES_LOCAL_DEV"] === "true" && typeof process.env["PIPES_PROJECT_ROOT"] !== "undefined";
...
const resolve = async (url, context, nextResolve)=>{
    ...
    /** If we are in source mode and this is a local package - fetch it! */ if (should_use_source_extension_for_local_packages && url.startsWith(localScope)) {
