...
export type CSS_PADDING_MARGIN =
  ...
  | `${CSS_DIMENSION_STYLE} ${CSS_DIMENSION_STYLE} ${CSS_DIMENSION_STYLE} ${CSS_DIMENSION_STYLE}`
  | `${CSS_DIMENSION_STYLE} ${CSS_DIMENSION_STYLE} ${CSS_DIMENSION_STYLE}`
  | `${CSS_DIMENSION_STYLE} ${CSS_DIMENSION_STYLE}`
  | `${CSS_DIMENSION_STYLE}`;
...
export const isNotNull = <T extends unknown>(arg: T): arg is notNull<T> => {
  return arg !== null;
};
